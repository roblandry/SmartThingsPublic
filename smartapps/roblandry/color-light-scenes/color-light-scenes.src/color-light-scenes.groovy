 ...
 */
definition(
	name: "Color Light Scenes",
	namespace: "roblandry/Color Light Scenes",
	author: "Rob Landry",
	description: "Sets the colors and brightness level of your Color lights and level of smart bulbs.",
	category: "Mode Magic",
	parent: "roblandry/Color Light Coordinator:Color Light Coordinator",
...
preferences {
	page(name: "mainPage", title: "Adjust the color of your Color lights to match your mood.", install: true, uninstall: true)
